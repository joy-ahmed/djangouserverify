"""
Django settings for pypl project.
...
SECRET_KEY = 'django-insecure-ddr7lhw5jfgtdz)ifqt=vay$23t)l(u*%fgby5tv5yo5wat(2w'
...
WSGI_APPLICATION = 'pypl.wsgi.application'
